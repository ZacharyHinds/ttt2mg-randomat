...
CreateConVar("ttt2_minigames_murder_knife_dmg", "100", {FCVAR_ARCHIVE}, "Murder knife damage")
...
SWEP.Primary.Damage         = GetConVar("ttt2_minigames_murder_knife_dmg"):GetInt()
